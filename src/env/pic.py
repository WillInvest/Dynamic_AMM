...
def plot_and_rank_models(model_nums, path, epsilon, USD=False):
    ...
    for model_num in model_nums:
        ...
        agent.act.load_state_dict(torch.load(f'saved_model/{path}/model_saves_step_{model_num}/actor_step_{model_num}.pth'))
...
path = 'AMM_2024-05-28_22-42-10_DDPG'
plot_and_rank_models(model_nums=sequence, path=path, epsilon=0.01, USD=False)
