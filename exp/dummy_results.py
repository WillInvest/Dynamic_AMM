...
def main(maker_dir, iterations=300, verbose=False):
    ...
    for sigma in sigma_values:
        ...
        for fee_rate in fee_rates:
            ...
            for seed in tqdm(range(iterations), desc=f'Sigma {sigma}, Fee Rate {fee_rate}'):
                ...
                total_pnl, total_fee, total_vol, price_distance, total_transaction = simulate_with_constant_fee_rate(fee_rate, seed, sigma=sigma)
