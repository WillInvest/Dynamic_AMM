        ...
        for fee_rate in fee_rates:
            for sigma in sigmas:
                ...
                for model_dir in model_dirs:
                    ...
                    market = MarketSimulator(start_price=1, deterministic=True, steps=50, sigma=0.1)
                    amm = AMM(initial_a=10000, initial_b=10000, fee=0.01)  # Set your fee rate
...
if __name__ == '__main__':
    ...
    MODEL_TYPE = 'TD3'
    FEE_RATES = np.arange(0.31, 0.41, 0.01)
